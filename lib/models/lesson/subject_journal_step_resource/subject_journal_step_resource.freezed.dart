...
SubjectJournalStepResource _$SubjectJournalStepResourceFromJson(
    Map<String, dynamic> json) {
  return _SubjectJournalStepResource.fromJson(json);
}

/// @nodoc
mixin _$SubjectJournalStepResource {
  ...
  bool get havePatterns => throw _privateConstructorUsedError;
  List<BaseUgcAnswerResource> get answers => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $SubjectJournalStepResourceCopyWith<SubjectJournalStepResource>
...
abstract class $SubjectJournalStepResourceCopyWith<$Res> {
  ...
  $Res call(
      ...
      int? checkpointMark,
      bool havePatterns,
      List<BaseUgcAnswerResource> answers});
}
...
/// @nodoc
abstract class _$$_SubjectJournalStepResourceCopyWith<$Res>
    implements $SubjectJournalStepResourceCopyWith<$Res> {
  factory _$$_SubjectJournalStepResourceCopyWith(
          _$_SubjectJournalStepResource value,
...
/// @nodoc
@JsonSerializable()
class _$_SubjectJournalStepResource implements _SubjectJournalStepResource {
...
// Дата создания в timestamp
  ...
  @override
  String toString() {
    return 'SubjectJournalStepResource(id: $id, title: $title, publicText: $publicText, publicTextOriginal: $publicTextOriginal, privateText: $privateText, privateTextOriginal: $privateTextOriginal, chapterId: $chapterId, number: $number, type: $type, authorId: $authorId, time: $time, hours: $hours, maxMark: $maxMark, clonedId: $clonedId, hidden: $hidden, createdAt: $createdAt, updatedAt: $updatedAt, passedStatusId: $passedStatusId, checkpointMark: $checkpointMark, havePatterns: $havePatterns, answers: $answers)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_SubjectJournalStepResourceToJson(
      this,
    );
  }
}

abstract class _SubjectJournalStepResource
    implements SubjectJournalStepResource, BaseStepResourceInterface {
  factory _SubjectJournalStepResource(
          ...
          required final bool havePatterns,
          required final List<BaseUgcAnswerResource> answers}) =
      _$_SubjectJournalStepResource;

  factory _SubjectJournalStepResource.fromJson(Map<String, dynamic> json) =
      _$_SubjectJournalStepResource.fromJson;
