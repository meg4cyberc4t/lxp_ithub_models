...
_$_SubjectJournalStepResource _$$_SubjectJournalStepResourceFromJson(
    ...
    _$_SubjectJournalStepResource(
      ...
      havePatterns: json['have_patterns'] as bool,
      answers: (json['answers'] as List<dynamic>)
          .map((e) => BaseUgcAnswerResource.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$_SubjectJournalStepResourceToJson(
        _$_SubjectJournalStepResource instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'have_patterns': instance.havePatterns,
