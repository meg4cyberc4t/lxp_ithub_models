...
GroupListForSubjectTimeStatisticsResource
    _$GroupListForSubjectTimeStatisticsResourceFromJson(
        Map<String, dynamic> json) {
  return _GroupListForSubjectTimeStatisticsResource.fromJson(json);
}

/// @nodoc
mixin _$GroupListForSubjectTimeStatisticsResource {
  ...
  @JsonKey(ignore: true)
  $GroupListForSubjectTimeStatisticsResourceCopyWith<
          GroupListForSubjectTimeStatisticsResource>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GroupListForSubjectTimeStatisticsResourceCopyWith<$Res> {
...
/// @nodoc
abstract class _$$_GroupListForSubjectTimeStatisticsResourceCopyWith<$Res>
    implements $GroupListForSubjectTimeStatisticsResourceCopyWith<$Res> {
  factory _$$_GroupListForSubjectTimeStatisticsResourceCopyWith(
          _$_GroupListForSubjectTimeStatisticsResource value,
...
/// @nodoc
@JsonSerializable()
class _$_GroupListForSubjectTimeStatisticsResource
    implements _GroupListForSubjectTimeStatisticsResource {
  ...
  factory _$_GroupListForSubjectTimeStatisticsResource.fromJson(
          Map<String, dynamic> json) =>
      _$$_GroupListForSubjectTimeStatisticsResourceFromJson(json);
  ...
  @override
  String toString() {
    return 'GroupListForSubjectTimeStatisticsResource(id: $id, name: $name, description: $description, companyId: $companyId, halfId: $halfId, labelId: $labelId, externalLink: $externalLink, createdAt: $createdAt, updatedAt: $updatedAt, students: $students)';
  }
  ...
  _$$_GroupListForSubjectTimeStatisticsResourceCopyWith<
      ...
      get copyWith =>
          __$$_GroupListForSubjectTimeStatisticsResourceCopyWithImpl<
              _$_GroupListForSubjectTimeStatisticsResource>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_GroupListForSubjectTimeStatisticsResourceToJson(
      this,
    );
  }
}

abstract class _GroupListForSubjectTimeStatisticsResource
    implements
        GroupListForSubjectTimeStatisticsResource,
        GroupResourceInterface {
  factory _GroupListForSubjectTimeStatisticsResource(
  ...
  factory _GroupListForSubjectTimeStatisticsResource.fromJson(
          Map<String, dynamic> json) =
      _$_GroupListForSubjectTimeStatisticsResource.fromJson;
