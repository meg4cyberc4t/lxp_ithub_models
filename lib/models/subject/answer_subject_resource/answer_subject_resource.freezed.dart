...
AnswerSubjectResource _$AnswerSubjectResourceFromJson(
    Map<String, dynamic> json) {
  return _AnswerSubjectResource.fromJson(json);
}

/// @nodoc
mixin _$AnswerSubjectResource {
  ...
  @JsonKey(ignore: true)
  $AnswerSubjectResourceCopyWith<AnswerSubjectResource> get copyWith =>
...
/// @nodoc
abstract class _$$_AnswerSubjectResourceCopyWith<$Res>
    implements $AnswerSubjectResourceCopyWith<$Res> {
  factory _$$_AnswerSubjectResourceCopyWith(_$_AnswerSubjectResource value,
...
/// @nodoc
@JsonSerializable()
class _$_AnswerSubjectResource implements _AnswerSubjectResource {
...
// required int? time,
  ...
  Map<String, dynamic> toJson() {
    return _$$_AnswerSubjectResourceToJson(
      this,
    );
  }
}

abstract class _AnswerSubjectResource
    implements AnswerSubjectResource, BaseSubjectResourceInterface {
  factory _AnswerSubjectResource(
  ...
  factory _AnswerSubjectResource.fromJson(Map<String, dynamic> json) =
      _$_AnswerSubjectResource.fromJson;
