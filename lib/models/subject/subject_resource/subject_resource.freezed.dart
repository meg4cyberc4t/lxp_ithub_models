...
SubjectResource _$SubjectResourceFromJson(Map<String, dynamic> json) {
  return _SubjectResource.fromJson(json);
}

/// @nodoc
mixin _$SubjectResource {
  ...
  @JsonKey(ignore: true)
  $SubjectResourceCopyWith<SubjectResource> get copyWith =>
...
/// @nodoc
abstract class _$$_SubjectResourceCopyWith<$Res>
    implements $SubjectResourceCopyWith<$Res> {
  factory _$$_SubjectResourceCopyWith(
...
/// @nodoc
@JsonSerializable()
class _$_SubjectResource implements _SubjectResource {
  _$_SubjectResource(
      {required this.id,
      required this.title,
      this.code = '',
  ...
  Map<String, dynamic> toJson() {
    return _$$_SubjectResourceToJson(
      this,
    );
  }
}
