...
UserAnswerResource _$UserAnswerResourceFromJson(Map<String, dynamic> json) {
  return _UserAnswerResource.fromJson(json);
}

/// @nodoc
mixin _$UserAnswerResource {
  ...
  @JsonKey(ignore: true)
  $UserAnswerResourceCopyWith<UserAnswerResource> get copyWith =>
...
/// @nodoc
abstract class _$$_UserAnswerResourceCopyWith<$Res>
    implements $UserAnswerResourceCopyWith<$Res> {
  factory _$$_UserAnswerResourceCopyWith(_$_UserAnswerResource value,
...
/// @nodoc
@JsonSerializable()
class _$_UserAnswerResource implements _UserAnswerResource {
  ...
  factory _$_UserAnswerResource.fromJson(Map<String, dynamic> json) =>
      _$$_UserAnswerResourceFromJson(json);
  ...
  @override
  String toString() {
    return 'UserAnswerResource(id: $id, firstName: $firstName, lastName: $lastName, middleName: $middleName, email: $email, photoSrc: $photoSrc, lastVisit: $lastVisit, phone: $phone, photoSrcSmall: $photoSrcSmall, isSkillfolioReg: $isSkillfolioReg, isOnline: $isOnline, createdAt: $createdAt, updatedAt: $updatedAt, groups: $groups)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_UserAnswerResourceToJson(
      this,
    );
  }
}

abstract class _UserAnswerResource
    implements UserAnswerResource, UserShowResourceInterface {
  factory _UserAnswerResource(
      ...
      required final List<BaseGroupResource> groups}) = _$_UserAnswerResource;

  factory _UserAnswerResource.fromJson(Map<String, dynamic> json) =
      _$_UserAnswerResource.fromJson;
