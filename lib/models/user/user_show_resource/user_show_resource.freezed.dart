...
UserShowResource _$UserShowResourceFromJson(Map<String, dynamic> json) {
  return _UserShowResource.fromJson(json);
}

/// @nodoc
mixin _$UserShowResource {
  ...
  @JsonKey(ignore: true)
  $UserShowResourceCopyWith<UserShowResource> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UserShowResourceCopyWith<$Res> {
  factory $UserShowResourceCopyWith(
          UserShowResource value, $Res Function(UserShowResource) then) =
      _$UserShowResourceCopyWithImpl<$Res>;
  $Res call(
      {int id,
      String firstName,
      String lastName,
...
/// @nodoc
class _$UserShowResourceCopyWithImpl<$Res>
    implements $UserShowResourceCopyWith<$Res> {
  _$UserShowResourceCopyWithImpl(this._value, this._then);

  final UserShowResource _value;
  // ignore: unused_field
  final $Res Function(UserShowResource) _then;
...
/// @nodoc
abstract class _$$_UserShowResourceCopyWith<$Res>
    implements $UserShowResourceCopyWith<$Res> {
  factory _$$_UserShowResourceCopyWith(
          _$_UserShowResource value, $Res Function(_$_UserShowResource) then) =
      __$$_UserShowResourceCopyWithImpl<$Res>;
  @override
  $Res call(
      {int id,
      String firstName,
...
/// @nodoc
class __$$_UserShowResourceCopyWithImpl<$Res>
    extends _$UserShowResourceCopyWithImpl<$Res>
    implements _$$_UserShowResourceCopyWith<$Res> {
  __$$_UserShowResourceCopyWithImpl(
      _$_UserShowResource _value, $Res Function(_$_UserShowResource) _then)
      : super(_value, (v) => _then(v as _$_UserShowResource));

  @override
  _$_UserShowResource get _value => super._value as _$_UserShowResource;
  ...
  $Res call({
    ...
    return _then(_$_UserShowResource(
      id: id == freezed
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$_UserShowResource implements _UserShowResource {
  _$_UserShowResource(
      {required this.id,
  ...
  @override
  String toString() {
    return 'UserShowResource(id: $id, firstName: $firstName, lastName: $lastName, middleName: $middleName, email: $email, photoSrc: $photoSrc, lastVisit: $lastVisit, phone: $phone, photoSrcSmall: $photoSrcSmall, isSkillfolioReg: $isSkillfolioReg, isOnline: $isOnline, createdAt: $createdAt, updatedAt: $updatedAt, groups: $groups)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$$_UserShowResourceCopyWith<_$_UserShowResource> get copyWith =>
      __$$_UserShowResourceCopyWithImpl<_$_UserShowResource>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_UserShowResourceToJson(
      this,
    );
  }
}

abstract class _UserShowResource
    implements UserShowResource, UserShowResourceInterface {
  factory _UserShowResource(
      ...
      required final List<BaseGroupResource> groups}) = _$_UserShowResource;

  factory _UserShowResource.fromJson(Map<String, dynamic> json) =
      _$_UserShowResource.fromJson;
