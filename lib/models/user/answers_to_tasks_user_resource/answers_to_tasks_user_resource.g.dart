...
_$_AnswersToTasksUserResource _$$_AnswersToTasksUserResourceFromJson(
...
Map<String, dynamic> _$$_AnswersToTasksUserResourceToJson(
        _$_AnswersToTasksUserResource instance) =>
    <String, dynamic>{
      'id': instance.id,
