...
BaseUserResource _$BaseUserResourceFromJson(Map<String, dynamic> json) {
  return _BaseUserResource.fromJson(json);
}

/// @nodoc
mixin _$BaseUserResource {
  ...
  @JsonKey(ignore: true)
  $BaseUserResourceCopyWith<BaseUserResource> get copyWith =>
...
/// @nodoc
abstract class _$$_BaseUserResourceCopyWith<$Res>
    implements $BaseUserResourceCopyWith<$Res> {
  factory _$$_BaseUserResourceCopyWith(
...
/// @nodoc
@JsonSerializable()
class _$_BaseUserResource implements _BaseUserResource {
  _$_BaseUserResource(
      {required this.id,
  ...
  factory _$_BaseUserResource.fromJson(Map<String, dynamic> json) =>
      _$$_BaseUserResourceFromJson(json);
  ...
  @override
  String toString() {
    return 'BaseUserResource(id: $id, firstName: $firstName, lastName: $lastName, middleName: $middleName, email: $email, photoSrc: $photoSrc, lastVisit: $lastVisit, phone: $phone, photoSrcSmall: $photoSrcSmall, isSkillfolioReg: $isSkillfolioReg, isOnline: $isOnline, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_BaseUserResourceToJson(
      this,
    );
  }
}
...
abstract class _BaseUserResource
  ...
  factory _BaseUserResource.fromJson(Map<String, dynamic> json) =
      _$_BaseUserResource.fromJson;
