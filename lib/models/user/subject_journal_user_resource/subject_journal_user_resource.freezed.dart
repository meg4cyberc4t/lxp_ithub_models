...
SubjectJournalUserResource _$SubjectJournalUserResourceFromJson(
    Map<String, dynamic> json) {
  return _SubjectJournalUserResource.fromJson(json);
}

/// @nodoc
mixin _$SubjectJournalUserResource {
  ...
  @JsonKey(ignore: true)
  $SubjectJournalUserResourceCopyWith<SubjectJournalUserResource>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SubjectJournalUserResourceCopyWith<$Res> {
  factory $SubjectJournalUserResourceCopyWith(SubjectJournalUserResource value,
          $Res Function(SubjectJournalUserResource) then) =
      _$SubjectJournalUserResourceCopyWithImpl<$Res>;
  $Res call(
      {int id,
      String firstName,
      String lastName,
...
/// @nodoc
class _$SubjectJournalUserResourceCopyWithImpl<$Res>
    implements $SubjectJournalUserResourceCopyWith<$Res> {
  _$SubjectJournalUserResourceCopyWithImpl(this._value, this._then);

  final SubjectJournalUserResource _value;
  // ignore: unused_field
  final $Res Function(SubjectJournalUserResource) _then;
...
/// @nodoc
abstract class _$$_SubjectJournalUserResourceCopyWith<$Res>
    implements $SubjectJournalUserResourceCopyWith<$Res> {
  factory _$$_SubjectJournalUserResourceCopyWith(
          _$_SubjectJournalUserResource value,
          $Res Function(_$_SubjectJournalUserResource) then) =
      __$$_SubjectJournalUserResourceCopyWithImpl<$Res>;
  @override
  $Res call(
      {int id,
      String firstName,
...
/// @nodoc
class __$$_SubjectJournalUserResourceCopyWithImpl<$Res>
    extends _$SubjectJournalUserResourceCopyWithImpl<$Res>
    implements _$$_SubjectJournalUserResourceCopyWith<$Res> {
  __$$_SubjectJournalUserResourceCopyWithImpl(
      _$_SubjectJournalUserResource _value,
      $Res Function(_$_SubjectJournalUserResource) _then)
      : super(_value, (v) => _then(v as _$_SubjectJournalUserResource));

  @override
  _$_SubjectJournalUserResource get _value =>
      super._value as _$_SubjectJournalUserResource;
  ...
  $Res call({
    ...
    return _then(_$_SubjectJournalUserResource(
      id: id == freezed
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$_SubjectJournalUserResource implements _SubjectJournalUserResource {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_SubjectJournalUserResource &&
  ...
  @JsonKey(ignore: true)
  @override
  _$$_SubjectJournalUserResourceCopyWith<_$_SubjectJournalUserResource>
      get copyWith => __$$_SubjectJournalUserResourceCopyWithImpl<
          _$_SubjectJournalUserResource>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SubjectJournalUserResourceToJson(
      this,
    );
  }
}

abstract class _SubjectJournalUserResource
    implements SubjectJournalUserResource, UserShowResourceInterface {
  factory _SubjectJournalUserResource(
  ...
  factory _SubjectJournalUserResource.fromJson(Map<String, dynamic> json) =
      _$_SubjectJournalUserResource.fromJson;
